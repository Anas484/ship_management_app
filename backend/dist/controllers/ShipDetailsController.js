...
//Create Ship Details
const createShipDetails = async (req, res) => {
    try {
...
const updateShipDetails = async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const data = Object.fromEntries(Object.entries(parsed.data).filter(([_, v]) => v !== undefined));
...
const deleteShipDetails = async (req, res) => {
    try {
        const { id } = req.params;
...
//# sourceMappingURL=ShipDetailsController.js.map