...
function page() {
  ...
  return (
    <div className='relative flex flex-col flex-1 justify-center items-center'>
        <h1 className="absolute top-60 left-100 -translate-x-1/2 -translate-y-1/2 text-[13vw] font-black text-gray-200 select-none pointer-events-none">
        Fathom
      </h1>
      <h1 className="absolute top-130 left-130 -translate-x-1/2 -translate-y-1/2 text-[13vw] font-black text-gray-200 select-none pointer-events-none">
        Maritime
      </h1>
      <div className='relative left-110 border-4 p-5 rounded-lg w-100 border-white shadow-2xl'>
        ...
        <FieldGroup>
            ...
            <div className='flex justify-center items-center w-50 ml-20'>
                <Field>
